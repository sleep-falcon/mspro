package middleware.schedule.service;
...
import static middleware.schedule.common.Constants.Global.LINE;
import static middleware.schedule.common.Constants.Global.path_root;
...
public class ZkCuratorServer {
    ...
    public static void createNode(CuratorFramework client, String path) throws Exception {
        ...
        for (int i = pathChild.size() - 1; i >= 0; i--) {
            ...
            if (null == stat) {
                client.create().creatingParentsIfNeeded().withMode(CreateMode.PERSISTENT).forPath(pathChild.get(i));
            }
        }
    }
    ...
    //添加临时节点数据
    public static void appendEphemeralData(CuratorFramework client, String path, String data) throws Exception {
